...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 65%; padding-left: 15px; ">
       <span style="font-size: 40px; font-weight: bold;">Sindhu Achudan</span><br><span style="font-size: 16px; font-style: italic;">Manager, Strategy and Masterplanning, SNDGO</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column">
       <span style="font-size: 40px; font-weight: bold;">Loh Shin Yee</span><br><span style="font-size: 22px; font-style: italic;">Assistant Director, Government Data Office, Data Policy, SNDGO</span>
    <p>We continuously think of ways to better use data to serve the public better. I am in the team that sets out policies that govern how data is managed in the Government. This includes the establishment of the Public Sector Data Governance Framework and the personal data protection policies to improve the transparency of our data security regime.</p>
      </div>
</div>


<div class="row" style="background-color: #f3f3f3;">
      <div class="column"><img src="images/ho-jin-chong.jpg" width="300" alt="Ho Jin Chong"></div>
      <div class="column">
       <span style="font-size: 40px; font-weight: bold;">Ho Jin Chong</span><br><span style="font-size: 22px; font-style: italic;">Assistant Manager, Policy & Technology, IMDA</span>
    <p>This is a dynamic sector to work in because technology evolves rapidly and it’s vital to ensure that policy evolves with industry needs. There is a role for everyone to contribute to growing and shaping the digital economy. I find it is meaningful to work on policy solutions that benefit consumers and organisations alike.</p>
      </div>
</div>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column">
       <span style="font-size: 40px; font-weight: bold;">Wong De Ming</span><br><span style="font-size: 22px; font-style: italic;">Senior Infocomm Specialist, Infocomm Division / Infocomm Technology & Planning Branch, IRAS</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column">
       <span style="font-size: 40px; font-weight: bold;">Ng Choon Sze Daphne</span><br><span style="font-size: 22px; font-style: italic;">Infocomm Specialist, Infocomm Division / Infocomm Technology & Planning Branch, IRAS</span>
    <p>We’re always striving to improve our digital services. I enjoy delivering an enhanced tax experience to taxpayers by working closely with programme track leads to ensure that project milestones are met.</p>
      </div>
</div>