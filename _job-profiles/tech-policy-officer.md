...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 10px 20px 20px 20px;">
       <span style="font-size: 26px; font-weight: bold; line-height: 30px;">Sindhu Achudan</span><br><span style="font-size: 14px; font-style: italic;">Manager, Strategy and Masterplanning, SNDGO</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width:80%; padding: 10px 20px 20px 20px;">
       <span style="font-size: 26px; font-weight: bold; line-height: 30px;">Loh Shin Yee</span><br><span style="font-size: 14px; font-style: italic;">Assistant Director, Government Data Office, Data Policy, SNDGO</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 10px 20px 20px 20px; ">
       <span style="font-size: 26px; font-weight: bold; line-height: 30px;">Ho Jin Chong</span><br><span style="font-size: 14px; font-style: italic;">Assistant Manager, Policy & Technology, IMDA</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 10px 20px 20px 20px;">
       <span style="font-size: 26px; font-weight: bold; line-height: 30px;">Justin Teh</span><br><span style="font-size: 14px; font-style: italic;">Assistant Director, SNDGO</span>
