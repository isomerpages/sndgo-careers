...
<div class="row">
  <div class="column"><ul>
   ...
   <li style="font-size: 20px; line-height: 26px;">Strong communication, interpersonal skill and stakeholder management to work and build relationships with a range of stakeholders holding different views</li>
	...
	<div class="column" style="text-align: right; width: 60%;"><span style="font-size:40px; font-weight: 700; color: #333333; line-height: 40px; ">WHO WE ARE LOOKING FOR</span><br><img src="images/job-profile-2.jpg" width="100%"></p></div>
</div>
