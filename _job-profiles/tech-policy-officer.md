...
<div class="row" style="background-color: #f3f3f3;">
      <div class="column" style="width: 50%; padding: 20px 0px 20px 20px;"><img src="images/sindhu-achudan.jpg" width="300" alt="Sindhu Achudan"></div>
      <div class="column" style="width: 50%; padding: 20px 20px 20px 20px;">
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 20px 20px 20px 20px; ">
       <span style="font-size: 28px; font-weight: bold; line-height: 40px;">Ho Jin Chong</span><br><span style="font-size: 15px; font-style: italic;">Assistant Manager, Policy & Technology, IMDA</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 20px 20px 20px 20px;">
       <span style="font-size: 28px; font-weight: bold; line-height: 40px;">Wong De Ming</span><br><span style="font-size: 15px; font-style: italic;">Senior Infocomm Specialist, Infocomm Division / Infocomm Technology & Planning Branch, IRAS</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 20px 20px 20px 20px;">
       <span style="font-size: 28px; font-weight: bold; line-height: 40px;">Ng Choon Sze Daphne</span><br><span style="font-size: 15px; font-style: italic;">Infocomm Specialist, Infocomm Division / Infocomm Technology & Planning Branch, IRAS</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 80%; padding: 20px 20px 20px 20px;">
       <span style="font-size: 28px; font-weight: bold; line-height: 40px;">Justin Teh</span><br><span style="font-size: 15px; font-style: italic;">Assistant Director, SNDGO</span>
