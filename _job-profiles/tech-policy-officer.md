...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 78%; padding: 20px 20px 20px 20px;">
       <span style="font-size: 40px; font-weight: bold;">Loh Shin Yee</span><br><span style="font-size: 16px; font-style: italic;">Assistant Director, Government Data Office, Data Policy, SNDGO</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 78%; padding: 20px 20px 20px 20px; ">
       <span style="font-size: 40px; font-weight: bold;">Ho Jin Chong</span><br><span style="font-size: 16px; font-style: italic;">Assistant Manager, Policy & Technology, IMDA</span>
...
<div class="row" style="background-color: #f3f3f3;">
      ...
      <div class="column" style="width: 78%; padding: 20px 20px 20px 20px;">
       <span style="font-size: 40px; font-weight: bold; line-height: 38px;">Ng Choon Sze Daphne</span><br><span style="font-size: 16px; font-style: italic;">Infocomm Specialist, Infocomm Division / Infocomm Technology & Planning Branch, IRAS</span>
